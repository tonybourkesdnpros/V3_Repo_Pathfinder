...
| --------- | ----------- | ------------ | --------------------- | ------------ | --- |
| IE-Ethernet3 | Internet Exit DEFAULT_INTERNET_EXIT | 192.16.51.1 | SET-Ethernet3 | False | - |
...
| ---- | --------- | -------- | ------------------------- |
| IE-Ethernet3 | Ethernet3 | 192.16.51.1 | IE-Ethernet3 |
...
router service-insertion
   connection IE-Ethernet3
      interface Ethernet3 next-hop 192.16.51.1
...
ip access-list ACL-NAT-IE-DIRECT
   10 deny ip host 192.16.51.2 any
