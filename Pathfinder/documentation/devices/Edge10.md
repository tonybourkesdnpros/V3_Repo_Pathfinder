...
| ------------ | --------------------------------- | ------------------------- | ------------------- | ---------- |
| FLOW-TRACKER | 70000 | 300000 | 1 | Dps1<br>Ethernet4<br>Ethernet5 |
...
| --------- | ----------- | ------------ | --------------------- | ------------ | --- |
| IE-Ethernet5 | Internet Exit DEFAULT_INTERNET_EXIT | 192.10.16.2 | SET-Ethernet5 | False | - |
...
monitor connectivity
   no shutdown
   interface set SET-Ethernet5 Ethernet5
   !
   host IE-Ethernet5
      description
      Internet Exit DEFAULT_INTERNET_EXIT
      local-interfaces SET-Ethernet5
      ip 192.10.16.2
```
...
| ----------- | ------------ | ---------- | -------- | -------- |
| DP-IKE-POLICY | - | - | - | 10.99.102.10 |
| CP-IKE-POLICY | - | - | - | 10.99.102.10 |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.99.102.10/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | DIRECT LAN HA LINK | routed | - | 10.10.10.0/31 | default | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.99.101.10/32 |
...
| DEFAULT-AVT-POLICY-DEFAULT | LB-DEFAULT-AVT-POLICY-DEFAULT | DEFAULT_INTERNET_EXIT |
...
| ---- | --------- | -------- | ------------------------- |
| IE-Ethernet5 | Ethernet5 | 192.10.16.2 | IE-Ethernet5 |
...
!
router service-insertion
   connection IE-Ethernet5
      interface Ethernet5 next-hop 192.10.16.2
      monitor connectivity host IE-Ethernet5
```
...
| 10.99.102.11 | 65000 | default | - | all | - | - | - | - | True | - | - |
...
| --- | ------------------- | ------------ |
| default | 10.99.101.10:101 | - |
| VRF_A | 10.99.101.10:102 | connected |
...
router bgp 65000
   ...
   neighbor 10.99.102.11 remote-as 65000
   neighbor 10.99.102.11 description Edge11
   neighbor 10.99.102.11 route-reflector-client
   neighbor 10.99.102.11 update-source Dps1
   neighbor 10.99.102.11 route-map RM-WAN-HA-PEER-IN in
   neighbor 10.99.102.11 route-map RM-WAN-HA-PEER-OUT out
   neighbor 10.99.102.11 send-community
   ...
   address-family evpn
      ...
      neighbor 10.99.102.11 activate
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.99.101.10:101 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.99.101.10:101 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.99.101.10:101 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.99.101.10:101 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.99.101.10:101
```
...
ip access-list ACL-NAT-IE-DIRECT
   10 deny ip host 192.10.16.1 any
...
| Router IP | Name | IPv4 address(es) |
| --------- | ---- | ---------------- |
| 10.99.102.11 | Edge11 | 10.10.10.1 |
...
router path-selection
   ...
   path-group LAN_HA id 65535
      ...
      !
      peer static router-ip 10.99.102.11
         name Edge11
...
| --------------- | ----------------- | ----------- |
| DEFAULT_INTERNET_EXIT | IE-Ethernet5 | - |
