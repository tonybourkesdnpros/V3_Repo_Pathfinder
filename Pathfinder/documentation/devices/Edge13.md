...
| --------- | ----------- | ------------ | --------------------- | ------------ | --- |
| IE-Ethernet3 | Internet Exit DEFAULT_INTERNET_EXIT | 192.13.16.2 | SET-Ethernet3 | False | - |
...
| ---- | --------- | -------- | ------------------------- |
| IE-Ethernet3 | Ethernet3 | 192.13.16.2 | IE-Ethernet3 |
...
router service-insertion
   connection IE-Ethernet3
      interface Ethernet3 next-hop 192.13.16.2
...
ip access-list ACL-NAT-IE-DIRECT
   10 deny ip host 192.13.16.1 any
