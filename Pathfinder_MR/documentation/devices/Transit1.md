...
| --------- | ----------- | ------------ | --------------------- | ------------ | --- |
| IE-Ethernet3 | Internet Exit DEFAULT_INTERNET_EXIT | 11.11.51.1 | SET-Ethernet3 | False | - |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.99.102.51/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | mpls_r1 | routed | - | 172.16.51.2/24 | default | - | False | - | - |
| Ethernet3 | internet | routed | - | 11.11.51.2/24 | default | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.99.101.51/32 |
...
| ---- | --------- | -------- | ------------------------- |
| IE-Ethernet3 | Ethernet3 | 11.11.51.1 | IE-Ethernet3 |
...
router service-insertion
   connection IE-Ethernet3
      interface Ethernet3 next-hop 11.11.51.1
...
| --- | ------------------- | ------------ |
| default | 10.99.101.51:101 | - |
| VRF_A | 10.99.101.51:102 | connected |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.99.101.51:199 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.99.101.51:199 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.99.101.51:199 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.99.101.51:199 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.99.101.51:199
```
...
ip access-list ACL-NAT-IE-DIRECT
   10 deny ip host 11.11.51.2 any
...
| Interface name | Public address | STUN server profile(s) |
| -------------- | -------------- | ---------------------- |
| Ethernet2 | - | mpls_r1_path-Pathfinder1-Ethernet2<br>mpls_r1_path-Pathfinder2-Ethernet2 |
