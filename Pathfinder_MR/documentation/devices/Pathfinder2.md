...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | mpls_r1 | routed | - | 172.16.2.2/24 | default | - | False | - | - |
| Ethernet3 | internet | routed | - | 11.11.2.2/24 | default | - | False | - | - |
...
| LB-PROD-AVT-POLICY-DEFAULT | - | - | - | internet_path (1)<br>LAN_HA (1)<br>mpls_r1_path (1)<br>mpls_r2_path (1) | False |
