...
| --------- | ----------- | ------------ | --------------------- | ------------ | --- |
| IE-Ethernet2 | Internet Exit DEFAULT_INTERNET_EXIT | 11.11.52.1 | SET-Ethernet2 | False | - |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.99.102.52/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | internet | routed | - | 11.11.52.2/24 | default | - | False | - | - |
| Ethernet3 | mpls_r1 | routed | - | 172.16.52.2/24 | default | - | False | - | - |

##### IP NAT: Interfaces configured via profile

| Interface | Profile |
| --------- |-------- |
| Ethernet2 | NAT-IE-DIRECT |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.99.101.52/32 |
...
| ---- | --------- | -------- | ------------------------- |
| IE-Ethernet2 | Ethernet2 | 11.11.52.1 | IE-Ethernet2 |
...
router service-insertion
   connection IE-Ethernet2
      interface Ethernet2 next-hop 11.11.52.1
...
| --- | ------------------- | ------------ |
| default | 10.99.101.52:101 | - |
| VRF_A | 10.99.101.52:102 | connected |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.99.101.52:199 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.99.101.52:199 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.99.101.52:199 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.99.101.52:199 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.99.101.52:199
```
...
ip access-list ACL-NAT-IE-DIRECT
   10 deny ip host 11.11.52.2 any
...
| -------------- | -------------- | ---------------------- |
| Ethernet2 | - | internet_path-Pathfinder1-Ethernet3<br>internet_path-Pathfinder2-Ethernet3<br>internet_path-Pathfinder3-Ethernet3<br>internet_path-Pathfinder4-Ethernet3 |
...
| Interface name | Public address | STUN server profile(s) |
| -------------- | -------------- | ---------------------- |
| Ethernet3 | - | mpls_r1_path-Pathfinder1-Ethernet2<br>mpls_r1_path-Pathfinder2-Ethernet2 |
...
| Router IP | Name | IPv4 address(es) |
| --------- | ---- | ---------------- |
| 10.99.102.1 | Pathfinder1 | 172.16.1.2 |
| 10.99.102.2 | Pathfinder2 | 172.16.2.2 |
...
| LB-PROD-AVT-POLICY-DEFAULT | - | - | - | internet_path (1)<br>mpls_r1_path (1) | False |
...
router path-selection
   ...
   path-group mpls_r1_path id 1002
      ...
      local interface Ethernet3
         stun server-profile mpls_r1_path-Pathfinder1-Ethernet2 mpls_r1_path-Pathfinder2-Ethernet2
      !
      peer dynamic
      !
      peer static router-ip 10.99.102.1
...
| --------------- | ----------------- | ----------- |
| DEFAULT_INTERNET_EXIT | IE-Ethernet2 | - |
...
| mpls_r1_path-Pathfinder1-Ethernet2 | 172.16.1.2 | STUN-DTLS | 3478 |
| mpls_r1_path-Pathfinder2-Ethernet2 | 172.16.2.2 | STUN-DTLS | 3478 |
...
stun
   client
      ...
      server-profile internet_path-Pathfinder4-Ethernet3
         ...
         ssl profile STUN-DTLS
      server-profile mpls_r1_path-Pathfinder1-Ethernet2
         ip address 172.16.1.2
         ssl profile STUN-DTLS
      server-profile mpls_r1_path-Pathfinder2-Ethernet2
